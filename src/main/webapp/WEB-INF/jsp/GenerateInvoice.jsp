...
<div class="container" style="margin-top:5%">
	<table id="invoice_header" style="width: 100%;border:1px solid #0c0c0c;">
		<tr>
		<td  style="width: 20%;border-right:1px solid #0c0c0c;text-align: center;border-top:1px solid #0c0c0c;">
		<img src="images/bg-logo.jpg" style="height: 150px;width: 130px;"></img></td>
		<td  style="border-left:1px solid #0c0c0c;text-align: center;">
		<div class="row" style="text-align: center; font-size: 20px;margin:0px !important;border-bottom:1px solid #0c0c0c;">TAX INVOICE
		</div>
		<div class="row" style="text-align: center; font-size: 20px;margin::0px !important;font-weight: bold;font-family: Arial Black;border-bottom:1px solid #0c0c0c;" id="companyName">
 		</div>
		...
		<div class="col-md-6 col-sm-6">
			Tel No. <span id="companyPhone" style="font-weight: bold;font-family: Arial Black;"></span>
		...
		<table style="width: 100%;border-left:1px solid #0c0c0c;border-right :1px solid #0c0c0c;border-bottom:1px solid #0c0c0c;">
		<tr>
		
		<td style="border-right:1px solid #0c0c0c;font-weight: bold;background: lightgrey;">
			&nbsp;&nbsp;Customer Name & Address
		</td>
		<td style="border-right:1px solid #0c0c0c;width: 10%; inline-size: 150px;background: lightgrey;border-bottom:1px solid #0c0c0c;">
		&nbsp;&nbsp;Invoice No
		</td>
		<td id="orderInvoiceNo" style="border-right:1px solid #0c0c0c; inline-size: 150px;font-weight:bold;">
		</td>
		</tr>
		<tr>
		<td    style="border-right:1px solid #0c0c0c;border-top:1px solid #0c0c0c;text-transform: uppercase;vertical-align:top;" rowspan="6">
		...
		<td style="border-right:1px solid #0c0c0c; inline-size: 150px; background: lightgrey">
		 ...
		 <td style="border-right:1px solid #0c0c0c; border-top:1px solid #0c0c0c; inline-size: 150px;font-weight:bold;">
		...
		<td id="customerNumber" style="border-right:1px solid #0c0c0c;border-top:1px solid #0c0c0c;font-weight:bold;">
		 
		</td>
		
		</tr>
		<tr>
		<td style="border-right:1px solid #0c0c0c;border-top:1px solid #0c0c0c; inline-size: 150px;background: lightgrey">
		&nbsp;&nbsp;Dispatch By 
		</td>
		<td id="dispatchThrough" style="border-right:1px solid #0c0c0c;border-top:1px solid #0c0c0c; inline-size: 150px;text-transform: uppercase;font-weight:bold;">
		 
		</td>
		
		</tr> 
		<tr>
		<td style="border-right:1px solid #0c0c0c;border-top:1px solid #0c0c0c;border-bottom:1px solid #0c0c0c; inline-size: 150px;background: lightgrey">
		&nbsp;&nbsp;Vehicle No
		</td>
		<td id="vehicleNo" style="border-right:1px solid #0c0c0c;border-top:1px solid #0c0c0c; font-weight:bold; inline-size: 150px;text-transform: uppercase;border-bottom:1px solid #0c0c0c;">

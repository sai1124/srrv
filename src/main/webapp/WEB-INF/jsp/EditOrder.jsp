...
<body>
	...
	<div class="container">
		...
		<div class="col-md-6" id="button_section">
			...
			<input type="button" id="modifyInvoice" style="float: right;margin-right: 20px;" class="btn btn-primary" value="Create Invoice"></input>  
		</div> 
		</div>
	</div>
	<br>
			  ...
			  <div class="col-sm-3 col-md-3">
					<div class="form-group1">
						<label>Customer Address</label> <textarea
							id="customerAddress" name="customerAddress" class="form-control" style="width: 300px; height: 120px;" ></textarea>
					</div>
				</div>
		 <br>
	</div>
	 ...
	 <div id="paymentPopUp" class="modal">
		<div class="modal-content" style="width: 50%; left: 27%;">
					...
					<div class="col-sm-3 col-md-4">
						<div class="form-group1">
							<label>Payment Ref</label> <br /> <input type="text"
								id="reference" name="reference" class="form-control" autocomplete="no-password"></input> 
			...
			<div class="modal-footer">
				<button value="Save" class="btn btn-primary"
					id="submitPaymentPopup">Save</button> <input type="button" value="Cancel"
